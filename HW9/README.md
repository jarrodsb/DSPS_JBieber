...
Second, I added alpha channel transparency to the points, to better show the density of points, and remove some of the ambiguity around grounded areas, particularly the points in the V band in the top left of the plot. For good measure, I also added alpha channel transparency to the best fit lines.

I did a few other small things, like adding grid lines, eliminitating a bit of horizontal white space, and improving the Title, x-axis, and y-axis labels to be a bit more descriptive. Overall, I think my changes have resulted in a visualization that more clearly conveys the desired information.
